CREATE DATABASE  IF NOT EXISTS `svp` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `svp`;
...
) ENGINE=InnoDB AUTO_INCREMENT=693 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `configuration` (
  ...
  `Value` mediumtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci
...
INSERT INTO `configuration` VALUES ('Logconfig','Verbose'),('Logconfig','Verbose'),('Logconfig','Verbose'),('Logconfig','Verbose');
...
CREATE TABLE `filesrelationship` (
  ...
  `System1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `System2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `Count` int NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=716340 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=26194 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `system` (
  ...
  `ConnectedRefSrcFile` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_new_project`(i_name VARCHAR(255),i_description mediumtext,i_path VARCHAR(4000))
BEGIN
	INSERT INTO Project(name,description,path) VALUES (i_name,i_description,i_path);
    SELECT last_insert_id();
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_project_description`(i_ProjectId BIGINT, i_description NVARCHAR(255))
BEGIN
	update `project`
    SET `project`.description = i_description
    where `project`.Id = i_ProjectId;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2023-02-23 22:11:20
